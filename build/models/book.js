            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, con.query(sql, [b.title, b.author, b.totalPages, b.summary])];
                    case 2:
                        _a.sent();
                        con.release();
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("can't insert the book, error: ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("can't delete the book, error: ".concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
